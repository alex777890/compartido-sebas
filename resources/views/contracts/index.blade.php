...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 main-content">
                ...
                <!-- Panel de filtro - SOLO VISIBLE EN LA PESTAÑA RECIENTES -->
                ...
                <div class="mb-4">
                    <ul class="nav nav-pills custom-tabs" id="pills-tab" role="tablist">
                        <li class="nav-item">
                            <button class="nav-link active" data-bs-toggle="pill" data-bs-target="#tab-recent" id="tab-recent-btn">Recientes</button>
                        </li>
                        <li class="nav-item">
                            <button class="nav-link" data-bs-toggle="pill" data-bs-target="#tab-templates" id="tab-templates-btn">Plantillas</button>
                        </li>
                        <li class="nav-item">
                            <button class="nav-link" data-bs-toggle="pill" data-bs-target="#tab-all" id="tab-all-btn">Historial Completo</button>
                        </li>
                    </ul>
                </div>
    ...
    <script>
        (function(){
            ...
            // Función para mostrar/ocultar el filtro según la pestaña activa
            function toggleFilterPanel() {
                const activeTab = document.querySelector('.custom-tabs .nav-link.active');
                if (activeTab) {
                    const tabId = activeTab.getAttribute('data-bs-target');
                    // Mostrar filtro SOLO en la pestaña de Recientes (tab-recent)
                    if (tabId === '#tab-recent') {
                        filterPanel.classList.remove('hidden-filter');
                    } else {
                        filterPanel.classList.add('hidden-filter');
                    }
                }
            }
            ...
            tabButtons.forEach(button => {
                button.addEventListener('click', function() {
                    // Pequeño retraso para que Bootstrap actualice la clase active
                    setTimeout(toggleFilterPanel, 50);
                });
            });
